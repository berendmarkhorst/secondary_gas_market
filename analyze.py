...
#     storage = {}
#     for n in m.nodes:
#         storage[n] = sum(problem[f"v[{t.trader_id},{n.node_id},{m.stage_id},{k.commodity_id}]"] for t in problem.traders for k in problem.commodities)
#
#     print(storage)